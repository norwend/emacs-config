...
* Общие настройки
** Установка пути запуска программ
#+begin_src emacs-lisp
  (setq exec-path '("/Users/stepan/.emacs.d/bin" "/Users/stepan/.bin" "/Users/stepan/opt/anaconda3/condabin" "/opt/homebrew/bin" "/opt/homebrew/sbin" "/usr/local/bin" "/usr/bin" "/bin" "/usr/sbin" "/sbin" "/opt/X11/bin" "/Library/Apple/usr/bin" "/Users/stepan/.cargo/bin"  "/opt/homebrew/Cellar/emacs-plus@28/28.1/libexec/emacs/28.1/aarch64-apple-darwin21.4.0"))
...
#+begin_src emacs-lisp
  (setq ndr/indent 4)
  (setq-default python-indent-offset ndr/indent)
  (setq-default c-basic-offset ndr/indent)
...
#+begin_src emacs-lisp
  (custom-theme-set-faces
     'user
     '(variable-pitch ((t (:family "PT Serif" :height 160))))
     '(fixed-pitch ((t ( :family "PT Mono" :height 160)))))
  
  (set-face-attribute 'default nil :family "PT Mono" :height 160)
#+end_src
** Doom-modeline
#+begin_src emacs-lisp
...
** C++
*** Быстрая компиляция файла из буфера
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  (defun ndr/cmake-conf-on-save ()
    "Sync org file to Raspberry Pi with external script."
  (when (eq major-mode 'cmake-mode)
    (projectile-configure-project "cmake . -b build -DCMAKE_EXPORT_COMPILE_COMMANDS=1")))

  (defun ndr/cmake-compile-run () (interactive)
    (projectile-compile-project "")
    (projectile-run-project ""))

  (add-hook 'after-save-hook #'ndr/cmake-conf-on-save)
...
#+begin_src emacs-lisp
  ...
  (general-define-key
   ...
   "mr" '(ndr/cmake-compile-run :which-key "Compile and run the project")
   )
